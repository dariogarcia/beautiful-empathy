...
class Game(tk.Tk):
    def __init__(self):
        ...
        self.key_image = tk.PhotoImage(file="tmp_dirs/icon.png")
        self.question_mark_image = tk.PhotoImage(file="tmp_dirs/icon.png")
...
if __name__ == "__main__":
    ...
    scene1 = GameScreen(game, "../boards/map_1.png", (378,135,427,217), "key", "You Need To Leave but the Door is Locked!")
    scene2 = GameScreen(game, "../boards/map_2.png", (117,54,329,412), None, "You Got the Key!")
    scene3 = GameScreen(game, "../boards/map_3.png", (117,54,329,412), None, "The Door is Open!")
